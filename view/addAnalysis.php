...
<p class="tips">Видалення аналізу призведе до видалення шаблону з усіма його параметрами.
    Видалення неможливе, якщо у базі даних збережено результати цього аналізу.</p>
<form action="addAnalysis.php" method="post">
